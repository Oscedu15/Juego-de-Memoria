...
let ganadorAudio = new Audio("/multimedia/sonidos/completado.wav");
let perdedorAudio = new Audio("/multimedia/sonidos/gameover.wav");
let clickAudio = new Audio("/multimedia/sonidos/continuacion.wav")
let errorAudio = new Audio("/multimedia/sonidos/erro.wav");
let acertoAudio = new Audio("/multimedia/sonidos/acerto.wav");
...
function bloquearTarjetas(){
    for(let i = 0; i<=15; i++){
        ...
        tarjetaBloqueada.innerHTML = `<img src="/multimedia/imagenes/${numeros[i]}.png" alt="">` ;
...
function destapar(id){
    ...
    if(tarjetasDestapadas == 1){
        ...
        tarjeta1.innerHTML = `<img src="/multimedia/imagenes/${primerResultado}.png" alt="">` ;
        clickAudio.play(); 
        ...
        tarjeta2.innerHTML = `<img src="/multimedia/imagenes/${segundoResultado}.png" alt="">`
